...
export default function FilterDropdown({ setFilteredCountries, countries }) {
    ...
    <div className="relative">
        <button
            className="flex bg-white p-5 rounded-sm shadow-md h-15 w-60 justify-between items-center text-[#1a1a1a] hover:cursor-pointer"
            onClick={handleClick}
        >
        ...
        <div
            className={`bg-white py-5 rounded-sm shadow-md absolute w-60 top-18 transition-all duration-300 ${
                visible
        ...
        >
            <ul>
                ...
                <li
                    ...
                    selectedRegions.includes(region) ? "bg-[#d1d1d1]" : ""
                    }`}
